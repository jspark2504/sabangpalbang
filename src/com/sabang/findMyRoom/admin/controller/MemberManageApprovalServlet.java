...
@WebServlet("/manage/approval")
public class MemberManageApprovalServlet extends HttpServlet {
...
//	      }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new AdminService().approvalOffice(no);
		
		String page = "";
		if(result > 0) {
			page = "/WEB-INF/views/common/success.jsp";
			request.setAttribute("successCode", "approvalOffice");
		} else {
			page = "/WEB-INF/views/common/failed.jsp";
			request.setAttribute("message", "중개사 승인 실패!");
