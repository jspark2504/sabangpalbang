...
<body>
   <jsp:include page="../common/header.jsp"/>
		...
		<form id="form" action="${ pageContext.servletContext.contextPath }/pagecount/List" method="get">
			...
			<input id="chartPageDay1" type="hidden" name="pageCountList1" value="${ requestScope.pageCountList8.pageDay }">

			<input id="chartViewNo2" type="hidden" name="pageCountList2" value="${ requestScope.pageCountList9.pageView }">
			<input id="chartPageDay2" type="hidden" name="pageCountList2" value="${ requestScope.pageCountList9.pageDay }">

			<input id="chartViewNo3" type="hidden" name="pageCountList3" value="${ requestScope.pageCountList10.pageView }">
			<input id="chartPageDay3" type="hidden" name="pageCountList3" value="${ requestScope.pageCountList10.pageDay }">

			<input id="chartViewNo4" type="hidden" name="pageCountList4" value="${ requestScope.pageCountList11.pageView }">
			<input id="chartPageDay4" type="hidden" name="pageCountList4" value="${ requestScope.pageCountList11.pageDay }">

			<input id="chartViewNo5" type="hidden" name="pageCountList5" value="${ requestScope.pageCountList12.pageView }">
			<input id="chartPageDay5" type="hidden" name="pageCountList5" value="${ requestScope.pageCountList12.pageDay }">

			<input id="chartViewNo6" type="hidden" name="pageCountList6" value="${ requestScope.pageCountList13.pageView }">
			<input id="chartPageDay6" type="hidden" name="pageCountList6" value="${ requestScope.pageCountList13.pageDay }">

			<input id="chartViewNo7" type="hidden" name="pageCountList7" value="${ requestScope.pageCountList14.pageView }">
			<input id="chartPageDay7" type="hidden" name="pageCountList7" value="${ requestScope.pageCountList14.pageDay }">
		</form>
