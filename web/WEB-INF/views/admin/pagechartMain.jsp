...
<body>
   <jsp:include page="../common/header.jsp"/>
		...
		<form id="form" action="${ pageContext.servletContext.contextPath }/pagecount/List" method="get">
			...
			<input id="chartPageDay1" type="hidden" name="pageCountList1" value="${ requestScope.pageCountList1.pageDay }">

			<input id="chartViewNo2" type="hidden" name="pageCountList2" value="${ requestScope.pageCountList2.pageView }">
			<input id="chartPageDay2" type="hidden" name="pageCountList2" value="${ requestScope.pageCountList2.pageDay }">

			<input id="chartViewNo3" type="hidden" name="pageCountList3" value="${ requestScope.pageCountList3.pageView }">
			<input id="chartPageDay3" type="hidden" name="pageCountList3" value="${ requestScope.pageCountList3.pageDay }">

			<input id="chartViewNo4" type="hidden" name="pageCountList4" value="${ requestScope.pageCountList4.pageView }">
			<input id="chartPageDay4" type="hidden" name="pageCountList4" value="${ requestScope.pageCountList4.pageDay }">

			<input id="chartViewNo5" type="hidden" name="pageCountList5" value="${ requestScope.pageCountList5.pageView }">
			<input id="chartPageDay5" type="hidden" name="pageCountList5" value="${ requestScope.pageCountList5.pageDay }">

			<input id="chartViewNo6" type="hidden" name="pageCountList6" value="${ requestScope.pageCountList6.pageView }">
			<input id="chartPageDay6" type="hidden" name="pageCountList6" value="${ requestScope.pageCountList6.pageDay }">

			<input id="chartViewNo7" type="hidden" name="pageCountList7" value="${ requestScope.pageCountList7.pageView }">
			<input id="chartPageDay7" type="hidden" name="pageCountList7" value="${ requestScope.pageCountList7.pageDay }">
		</form>
