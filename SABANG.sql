...
CREATE TABLE USER_CATEGORY (
  CATEGORY_NO NUMBER CONSTRAINT PK_UC_CATEGORY_NO PRIMARY KEY,
  CATEGORY_NAME	VARCHAR2(20) CONSTRAINT NN_UC_CATEGORY_NAME NOT NULL
);

COMMENT ON COLUMN USER_CATEGORY.CATEGORY_NO IS '구분코드';
COMMENT ON COLUMN USER_CATEGORY.CATEGORY_NAME IS '회원종류';


---------- 회원상태구분 ----------
CREATE TABLE USER_STATUS (
  STATUS_NO	NUMBER CONSTRAINT PK_US_STATUS_NO PRIMARY KEY,
  STATUS_NAME VARCHAR2(30) CONSTRAINT NN_US_STATUS_NAME NOT NULL
);

COMMENT ON COLUMN USER_STATUS.STATUS_NO IS '구분코드';
COMMENT ON COLUMN USER_STATUS.STATUS_NAME IS '회원상태';


---------- 회원 ----------
CREATE TABLE MEMBER (
  USER_NO NUMBER CONSTRAINT PK_M_USER_NO PRIMARY KEY,
  USER_ID VARCHAR2(20) CONSTRAINT NN_M_USER_ID NOT NULL,
  USER_PWD VARCHAR2(100) CONSTRAINT NN_M_USER_PWD NOT NULL,
  USER_NAME	VARCHAR2(20) CONSTRAINT NN_M_USER_NAME NOT NULL,
  EMAIL	VARCHAR2(30) CONSTRAINT NN_M_EMAIL NOT NULL,
  PHONE VARCHAR2(20) CONSTRAINT NN_M_PHONE NOT NULL,
  CATEGORY_NO NUMBER CONSTRAINT NN_M_CATEGORY_NO NOT NULL,
  APPLY_DATE DATE,
  APPROVAL_YN CHAR(1),
  REGISTER_DATE DATE,
  STATUS_NO NUMBER,
  WITHDRAW_DATE DATE,
  CONSTRAINT UK_M_USER_ID UNIQUE(USER_ID),
  CONSTRAINT UK_M_EMAIL UNIQUE(EMAIL),
  CONSTRAINT UK_M_PHONE UNIQUE(PHONE),
  CONSTRAINT CK_M_APPROVAL_YN CHECK(APPROVAL_YN IN ('Y', 'N')),
  CONSTRAINT FK_M_CATEGORY_NO FOREIGN KEY(CATEGORY_NO) REFERENCES USER_CATEGORY (CATEGORY_NO),
  CONSTRAINT FK_M_STATUS_NO FOREIGN KEY(STATUS_NO) REFERENCES USER_STATUS (STATUS_NO)
);
...
COMMENT ON COLUMN MEMBER.CATEGORY_NO IS '회원종류';
COMMENT ON COLUMN MEMBER.APPLY_DATE IS '가입신청일';
COMMENT ON COLUMN MEMBER.APPROVAL_YN IS '가입승인여부';
COMMENT ON COLUMN MEMBER.REGISTER_DATE IS '회원등록일';
COMMENT ON COLUMN MEMBER.STATUS_NO IS '회원상태';
COMMENT ON COLUMN MEMBER.WITHDRAW_DATE IS '탈퇴일';
...
CREATE TABLE OFFICE (
  ...
  CONSTRAINT FK_OF_USER_NO FOREIGN KEY (USER_NO) REFERENCES MEMBER (USER_NO),
...
CREATE TABLE ROOM(
  ...
  CONSTRAINT FK_RM_USER_NO FOREIGN KEY (USER_NO) REFERENCES MEMBER(USER_NO)
);
...
CREATE TABLE USER_DOCUMENT (
  ...
  CONSTRAINT FK_USER_NO FOREIGN KEY(USER_NO) REFERENCES MEMBER (USER_NO),
  CONSTRAINT FK_ROOM_NO FOREIGN KEY(ROOM_NO) REFERENCES ROOM (ROOM_NO)
);

COMMENT ON COLUMN USER_DOCUMENT.FILE_NO IS '파일번호';
COMMENT ON COLUMN USER_DOCUMENT.USER_NO IS '회원번호';
COMMENT ON COLUMN USER_DOCUMENT.ORIGIN_NAME IS '원본파일명';
COMMENT ON COLUMN USER_DOCUMENT.SAVE_NAME IS '저장파일명';
COMMENT ON COLUMN USER_DOCUMENT.EXTENSION IS '파일확장자';
COMMENT ON COLUMN USER_DOCUMENT.CONTENT IS '파일내용';
COMMENT ON COLUMN USER_DOCUMENT.REGISTER_DATE IS '등록일시';
COMMENT ON COLUMN USER_DOCUMENT.ROOM_NO IS '매물코드';
COMMENT ON COLUMN USER_DOCUMENT.SAVE_PATH IS '저장경로';
...
CREATE TABLE PICK_ROOM (
  ...
  CONSTRAINT FK_PR_USER_NO FOREIGN KEY(USER_NO) REFERENCES MEMBER (USER_NO),
  CONSTRAINT FK_PR_ROOM_NO FOREIGN KEY(ROOM_NO) REFERENCES ROOM (ROOM_NO)
);

COMMENT ON COLUMN PICK_ROOM.USER_NO IS '회원번호';
COMMENT ON COLUMN PICK_ROOM.ROOM_NO IS '매물코드';
...
CREATE TABLE TRANSACTION_LIST (
  ...
  CONSTRAINT FK_TL_USER_NO FOREIGN KEY(USER_NO) REFERENCES MEMBER (USER_NO),
...
CREATE TABLE REVIEW (
  ...
  CONSTRAINT FK_RV_USER_NO FOREIGN KEY(USER_NO) REFERENCES MEMBER (USER_NO)
);
...
CREATE TABLE REPORT (
  ...
  USER_NO NUMBER CONSTRAINT NN_RP_MEMBER_NO NOT NULL,
  ...
  CONSTRAINT FK_RP_USER_NO FOREIGN KEY (USER_NO) REFERENCES MEMBER (USER_NO),
...
CREATE TABLE FREE_BOARD(
  ...
  CONSTRAINT FK_FB_USER_NO FOREIGN KEY (USER_NO) REFERENCES MEMBER (USER_NO)
);
...
CREATE TABLE REPLY(
  ...
  CONSTRAINT FK_RE_USER_NO FOREIGN KEY (USER_NO) REFERENCES MEMBER (USER_NO)
);
...
CREATE TABLE PAYMENT_LIST(
  ...
  CONSTRAINT FK_PL_USER_NO FOREIGN KEY (USER_NO) REFERENCES MEMBER (USER_NO)
);
...
CREATE TABLE NOTICE(
  ...
  CONSTRAINT FK_NT_USER_NO FOREIGN KEY (USER_NO) REFERENCES MEMBER (USER_NO)
);
...
CREATE TABLE INFO_BOARD(
  ...
  CONSTRAINT FK_IB_USER_NO FOREIGN KEY (USER_NO) REFERENCES MEMBER (USER_NO)
);
